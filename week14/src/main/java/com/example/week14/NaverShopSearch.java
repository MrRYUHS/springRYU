...
public class NaverShopSearch {
    public String search(String query) {
        ...
        ResponseEntity<String> responseEntity = rest.exchange("https://openapi.naver.com/v1/search/shop.json", HttpMethod.GET, requestEntity, String.class);
    ...
    public static void main(String[] args) {
        ...
        String ret = naverShopSearch.search("어른맥");
